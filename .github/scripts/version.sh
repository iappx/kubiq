...
targets=(
    ...
    'build/darwin/Info.plist|/<key>CFBundleShortVersionString<\/key>/{n;s/.*<string>\([^<]*\)<\/string>.*/\1/p;}|/<key>CFBundleShortVersionString<\/key>/{n;s/<string>[^<]*<\/string>/<string>@V@<\/string>/;}|@V@'
    'build/darwin/Info.plist|/<key>CFBundleVersion<\/key>/{n;s/.*<string>\([^<]*\)<\/string>.*/\1/p;}|/<key>CFBundleVersion<\/key>/{n;s/<string>[^<]*<\/string>/<string>@V@<\/string>/;}|@V@'
    'build/darwin/Info.dev.plist|/<key>CFBundleShortVersionString<\/key>/{n;s/.*<string>\([^<]*\)<\/string>.*/\1/p;}|/<key>CFBundleShortVersionString<\/key>/{n;s/<string>[^<]*<\/string>/<string>@V@<\/string>/;}|@V@'
    'build/darwin/Info.dev.plist|/<key>CFBundleVersion<\/key>/{n;s/.*<string>\([^<]*\)<\/string>.*/\1/p;}|/<key>CFBundleVersion<\/key>/{n;s/<string>[^<]*<\/string>/<string>@V@<\/string>/;}|@V@'
